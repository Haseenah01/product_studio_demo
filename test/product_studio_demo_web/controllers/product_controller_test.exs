defmodule ProductStudioDemoWeb.ProductControllerTest do
  use ProductStudioDemoWeb.ConnCase

  import ProductStudioDemo.ProductsFixtures
  ...
  @invalid_attrs %{description: nil, name: nil, price: nil, stock: nil}
